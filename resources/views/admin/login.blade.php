									...
									<div class="form-body">
										<form method="POST" action="{{ route('login') }}" class="row g-3">
											...
											<div class="col-12">
												...
												<input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="john@example.com" required autofocus>
                                                @error('email')
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0 @error('password') is-invalid @enderror" id="password" 
